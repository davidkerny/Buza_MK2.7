...
#define PID_K1 0.95 // Derivative smoothing factor within any PID loop
#if ENABLED(PIDTEMP)
...
#define MOVE_BACK_BEFORE_HOMING
    ...
    #define MOVE_BACK_BEFORE_HOMING_DISTANCE 3.0f
#endif
...
#define DEFAULT_MAX_FEEDRATE \
    { 250, 250, 35, 45 }   // zpatky k rychlostem z FW 5  - mrdat crash detection.

/// HW limits of feed rate
#define HWLIMIT_NORMAL_MAX_FEEDRATE \
    { 400, 400, 40, 80 }  // z 12 na 40 sem menil podle ai je 35 hrana...
...
#define DEFAULT_MAX_ACCELERATION \
    { 1250, 1250, 400, 4000 }  // zpatky k petce
...
#define XY_PROBE_SPEED 12000 // bylo nebylo  // v 6ce problem snizuju z 15000 na 7000 to je trochu pomalejsi, dam 10k
...
#define X_BED_SIZE 248  //bylo 250 ale narazelo to o 2mm na AER MK27
#define Y_BED_SIZE 212  //bylo 210 ale heatbed nedojizdel do konce  (na krajich se uz zveda heatbed o ty koncovky, je to docela napicu, ale uprostred se to nezvedne tak je to takovy cikansky - funguje ale neidealni)
#define Z_SIZE 210      //byo 185 ale o 15mm to nedojizdelo, asi zustalo z minika, 212 uz narazi kdyz se jede, hodnota jde zmenit v menu a jednicku si to pridava

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS -1  // -1 je docela na hrane, ale bylo to tak, nechavam
#define Y_MIN_POS -4
#define Z_MIN_POS 0
...
//#define MANUAL_X_HOME_POS 180.4 //bylo odkomentovano a zpusobovalo to ten problem s trrrrr po home x a y
...
#define Z_SAFE_HOMING
    ...
    #define Z_SAFE_HOMING_X_POINT (36.5) //bylo 36.5// X point for Z homing when homing all axes (G28).
    #define Z_SAFE_HOMING_Y_POINT (14) //bylo 14 // Y point for Z homing when homing all axes (G28).
#endif

// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (60 * 60)  // mozna 70*60 bylo  30*60 je pomaly docela
#define HOMING_FEEDRATE_Z (10 * 60)    // 8x60 origo ale pomaly jaxwin
 ...
 */
    ...
    #define Y_AXIS_LOAD_POS    mapi::ParkingPosition::unchanged  //todo tady nezmeneno ale v starym bylo jinak 
    ...
    #define NOZZLE_PARK_Z_FEEDRATE 20 // (mm/s) Z axis feedrate (not used for delta printers)  // tady bylo 5 a byl to extrem slow
