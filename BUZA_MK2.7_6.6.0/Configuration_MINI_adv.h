 ...
 */
    ...
    #define THERMAL_PROTECTION_PERIOD 60 //20        // Seconds
    #define THERMAL_PROTECTION_HYSTERESIS 12 //6 //4     // Degrees Celsius
         ...
         */
        #define THERMAL_PROTECTION_MODEL_PERIOD 60 //40
        /**
         * 26.6% of PWM max.
 ...
 */
    ...
    #define THERMAL_PROTECTION_BED_PERIOD 60 //45 // Seconds
    #define THERMAL_PROTECTION_BED_HYSTERESIS 10 //25 // Degrees Celsius
 ...
 */
   ...
   */
    ...
    #define WATCH_CHAMBER_TEMP_INCREASE 2 // Degrees Celsius //pridano for no reason
#endif
